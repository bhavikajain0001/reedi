...
def main():
    ...
    if page == "REEdI Modules' Skillification Analysis":
        ...
        html_temp = """
			 <div class='tableauPlaceholder' id='viz1696603052493' style='position: relative'>
			  <noscript>
			    <a href='#'>
		...
		<script type='text/javascript'>
		  var divElement = document.getElementById('viz1696603052493');
		  var vizElement = divElement.getElementsByTagName('object')[0];
		  vizElement.style.width = '100%';
		  vizElement.style.height = (divElement.offsetWidth * 0.75) + 'px';
		  var scriptElement = document.createElement('script');
 	...
 	"""
        components.html(html_temp, width=1200, height=700)
